    ...
    def test_valid_puzzle(self):
        ...
        puzzle = Puzzle(
            ...
            solution=PuzzleSolution(
                type="multi-step", steps=[PuzzleStep(step="Step 1 description here")]
            ),
            difficulty="medium",
        )
    ...
    def test_difficulty_validation(self):
        ...
        with pytest.raises(ValidationError):
            Puzzle(
                ...
                narrative_purpose="Test purpose for narrative",
                solution=PuzzleSolution(
                    type="test", steps=[PuzzleStep(step="Step description here")]
                ),
        ...
        pd = PuzzleDesign(
            puzzles=[
                Puzzle(
                    ...
                    solution=PuzzleSolution(
                        type="test", steps=[PuzzleStep(step="Step description")]
                    ),
                    difficulty="easy",
                )
            ],
            ...
            PuzzleDesign(
                ...
                artifacts=[
                    Artifact(
                        ...
                        description="d",
                        location="s1",
                        narrative_significance="s" * 20,
                        properties=[ArtifactProperty(property="p")],
                    )
                ],
                monsters=[
                    Monster(
                ...
                npcs=[
                    NPC(
                        ...
                        name="N1",
                        role="r",
                        description="A grizzled veteran of the Imperial Guard, haunted by past battles.",
                        locations=["s1"],
                        dialogue_themes=["t"],
                    )
                ],
