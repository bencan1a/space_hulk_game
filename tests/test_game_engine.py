...
from src.space_hulk_game.engine.entities import NPC, Event, Item
...
class TestTextAdventureEngineInit(unittest.TestCase):
    ...
    def test_initialization_basic(self):
        ...
        scenes = {"room1": Scene(id="room1", name="Room 1", description="First room.")}
...
class TestActionHandlers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.state = GameState(
            current_scene="room1", inventory=["dataslate"], health=100, max_health=100
        )
        ...
        self.scenes = {
            ...
            "room2": Scene(
                id="room2", name="Room 2", description="The second room.", exits={"south": "room1"}
            ),
        }
...
class TestStateTransitions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.scenes = {
            "room1": Scene(
                id="room1", name="Room 1", description="First room.", exits={"north": "room2"}
            ),
            "room2": Scene(
                id="room2",
                name="Room 2",
...
class TestVictoryDefeat(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.scenes = {"room1": Scene(id="room1", name="Room 1", description="First room.")}
...
class TestPersistence(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.item = Item(id="key", name="Brass Key", description="An old key.", takeable=True)
        ...
        self.scenes = {
            ...
            "room2": Scene(id="room2", name="Room 2", description="Second room.", visited=True),
        }
...
class TestScriptedPlaythrough(unittest.TestCase):
    ...
    def test_basic_playthrough(self):
        ...
        key_item = Item(
            id="brass_key", name="Brass Key", description="An ornate key.", takeable=True
        )
        ...
        engine = TextAdventureEngine(
            state, scenes, input_func=mock_io.input_func, output_func=mock_io.output_func
        )
    ...
    def test_victory_playthrough(self):
        ...
        scenes = {
            "room1": Scene(
                id="room1", name="Starting Room", description="Beginning.", exits={"north": "vault"}
            ),
            "vault": Scene(
                id="vault",
                name="Sacred Vault",
    ...
    def test_defeat_playthrough(self):
        ...
        death_event = Event(
            id="trap", description="A trap springs!", trigger_on_entry=True, effects={"damage": 25}
        )
