...
class TestContentLoaderBasics(unittest.TestCase):
    ...
    def test_load_yaml_valid_file(self):
        ...
        self.assertEqual(
            data["narrative_foundation"]["title"],
            "Test Space Hulk Adventure"
        )
...
class TestContentLoaderIntegration(unittest.TestCase):
    ...
    def test_load_game_plot_points(self):
        ...
        discovery = next(
            (p for p in game_data.plot_points if p["id"] == "discovery"),
            None
        )
    ...
    def test_load_game_endings(self):
        ...
        # Find victory ending
        victory = next(
            (e for e in game_data.endings if e["id"] == "victory"),
            None
        )
...
class TestContentLoaderErrorHandling(unittest.TestCase):
    ...
    def test_load_game_missing_scenes_lenient(self):
        ...
        for filename in ["plot_outline.yaml", "narrative_map.yaml", 
                        "puzzle_design.yaml", "scene_texts.yaml", "prd_document.yaml"]:
