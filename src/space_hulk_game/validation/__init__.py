...
Exports:
    ...
    ValidationResult: Result dataclass containing validation status and errors (legacy)
    OutputCorrector: Auto-corrector for fixing common YAML validation errors
    CorrectionResult: Result dataclass containing correction status and changes (legacy)
"""
