...
class MechanicsMetrics:
    ...
    @classmethod
    def from_json_content(cls, json_content: str) -> "MechanicsMetrics":
        """
        Create MechanicsMetrics from JSON content string.

        Args:
            json_content: JSON string containing PRD/mechanics data
