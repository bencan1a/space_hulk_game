...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--inputs", type=str, help="Input in format key:value (e.g., prompt:Your prompt here)"
    )
    parser.add_argument(
        "command", nargs="?", choices=["run", "train", "replay", "test"], help="Command to execute"
    )
