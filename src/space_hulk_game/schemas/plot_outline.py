...
class PlotPoint(BaseModel):
    ...
    description: str = Field(
        ...,
        min_length=50,
        description="Detailed description of the plot point"
    )
...
class Character(BaseModel):
    ...
    role: str = Field(
        ...
        min_length=1,
        max_length=300,
        description="Character's role or position"
    )
    backstory: str = Field(
        ...,
        min_length=50,
    ...
    conflicts: Optional[List[str]] = Field(
        default=None,
        description="Optional character-specific conflicts"
    )
...
class Conflict(BaseModel):
    ...
    type: str = Field(
        ...
        min_length=1,
        max_length=200,
        description="Type or category of conflict"
    )
    description: str = Field(
        ...,
        min_length=50,
...
class PlotBranch(BaseModel):
    ...
    path: str = Field(
        ...
        min_length=1,
        max_length=200,
        description="Branch path identifier"
    )
    description: str = Field(
        ...,
        min_length=50,
        description="Description of the branch narrative"
    )
    decision_point: Optional[str] = Field(
        default=None,
        description="ID of the plot point where this branch occurs"
    )
...
class PlotOutline(BaseModel):
    ...
    setting: str = Field(
        ...,
        min_length=50,
        description="Detailed description of the setting and world"
    )
    themes: List[str] = Field(
        ...,
        min_length=1,
        description="List of major themes (at least 1 required)"
    )
    tone: str = Field(
        ...,
        min_length=10,
        max_length=500,
        description="Overall tone and atmosphere"
    )
    plot_points: List[PlotPoint] = Field(
        ...,
        min_length=3,
        description="Chronological list of major plot events (minimum 3)"
    )
    characters: List[Character] = Field(
        ...,
        min_length=1,
        description="List of major characters (at least 1 required)"
    )
    conflicts: List[Conflict] = Field(
        ...,
        min_length=1,
        description="List of major conflicts (at least 1 required)"
    )
    plot_branches: Optional[List[PlotBranch]] = Field(
        default=None,
        description="Optional alternative narrative paths"
    )
